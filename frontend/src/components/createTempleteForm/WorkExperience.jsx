        ...
        <div className="w-full lg:w-auto">
          ...
          <label className="input input-bordered flex items-center gap-2">
            <input
              ...
              onChange={(e) => onWorkExperienceChange("company", e.target.value)}
            />
          </label>
        </div>
        <div className="w-full lg:w-auto">
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input
              ...
              onChange={(e) => onWorkExperienceChange("position", e.target.value)}
            />
          </label>
        </div>
        <div className="w-full lg:w-auto">
          ...
          <label className="input input-bordered flex items-center gap-2">
            <input
              ...
              onChange={(e) => onWorkExperienceChange("startDate", e.target.value)}
            />
          </label>
        </div>
      </div>
        ...
        <div className="w-full lg:w-auto">
          ...
          <label className="input input-bordered flex items-center gap-2">
            <input
              ...
              onChange={(e) => onWorkExperienceChange("endDate", e.target.value)}
            />
          </label>
        </div>
        <div className="w-full lg:w-auto">
          ...
          <label className="  flex items-center gap-2">
            <textarea
              ...
              onChange={(e) => onWorkExperienceChange("description", e.target.value)}
        ...
        <div className="w-full lg:w-auto">
          ...
          <label className="input input-bordered flex items-center gap-2">
            <input
              ...
              onChange={(e) => onWorkExperienceChange("technologies", e.target.value)}
            />
          </label>
        </div>
      </div>
